...
const getGoodHours = (dd, mm, yy) => {
  ...
  switch (chiDay) {
    case 'Tý':
      goodHours = ['Tý', 'Sửu', 'Mão', 'Ngọ', 'Thân', 'Dậu'];
      break;
    case 'Sửu':
      goodHours = ['Dần', 'Mão', 'Tỵ', 'Thân', 'Tuất', 'Hợi'];
      break;
    case 'Dần':
      goodHours = ['Tý', 'Sửu', 'Dần', 'Mão', 'Mùi', 'Tuất'];
      break;
    case 'Mão':
      goodHours = ['Tý', 'Dần', 'Mão', 'Mùi', 'Thân', 'Tuất'];
      break;
    case 'Thìn':
      goodHours = ['Sửu', 'Thìn', 'Ngọ', 'Mùi', 'Thân', 'Dậu'];
      break;
    case 'Tỵ':
      goodHours = ['Dần', 'Mão', 'Tỵ', 'Ngọ', 'Thân', 'Dậu'];
      break;
    case 'Ngọ':
      goodHours = ['Tý', 'Sửu', 'Mão', 'Ngọ', 'Thân', 'Dậu'];
      break;
    ...
    case 'Thân':
      ...
      break;
    case 'Dậu':
      goodHours = ['Tý', 'Mão', 'Ngọ', 'Thân', 'Tuất', 'Hợi'];
      break;
    case 'Tuất':
      goodHours = ['Dần', 'Thìn', 'Tỵ', 'Thân', 'Dậu', 'Hợi'];
      break;
    case 'Hợi':
      goodHours = ['Sửu', 'Dần', 'Mão', 'Tỵ', 'Ngọ', 'Thân'];
      break;
  }
  return goodHours;
};

// LUNAR TO SOLAR CONVERSION (Đã sửa lỗi và thêm mới hàm)
const lunar2solar = (ld, lm, ly, isLeap) => {
  const A = 2415021.076998695;
  const B = 29.530588853;
  let k;
...
convertToSolarBtn.addEventListener('click', () => {
  ...
  const jd = lunar2solar(ld, lm, ly, leap);
